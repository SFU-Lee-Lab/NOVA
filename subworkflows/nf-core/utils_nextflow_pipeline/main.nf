...
workflow UTILS_NEXTFLOW_PIPELINE {
    ...
    out_dir               //    path: base directory used to publish pipeline results
    ...
    //
    if (dump_parameters && out_dir) {
        dumpParametersToJSON(out_dir)
    }
...
// Dump pipeline parameters to a JSON file
//
def dumpParametersToJSON(out_dir) {
    ...
    FilesEx.copyTo(temp_pf.toPath(), "${out_dir}/PIPELINE_INFO/params_${timestamp}.json")
    temp_pf.delete()
}
